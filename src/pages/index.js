...
export default function Home() {
    ...
    function  ExpresionRegular(tipo){
      switch(tipo){
        case 0:
          //Variable
          let cadena = '\^'
          tiposvariables.map((variable) =>{
            cadena.concat(`${variable}|`)
          })
          cadena.slice(0, -1)
          cadena.concat('$')
          return cadena
  ...
  return (
    ...
    <div className={styles.navegador}>
        ...
        {
          archivo && guardado ? <button className={styles.ejecutar}><i className="fa-solid fa-play"></i></button> : null
        }
        {archivo ? 
